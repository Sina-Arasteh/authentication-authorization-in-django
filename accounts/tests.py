...
class SignUpViewTests(TestCase):
    ...
    def test_rendered_template_by_get_request(self):
        """Tests if the view would render the right template"""
        response = self.c.get(reverse("accounts:signup"))
        self.assertTemplateUsed(response, 'accounts/signup.html')

    def test_rendered_template_by_post_method(self):
        """Tests the outputs of the view generated by POST requests"""
        response_bad = self.c.post(reverse("accounts:signup"))
        response_good = self.c.post(reverse("accounts:signup"), {
            "username": "Noah",
